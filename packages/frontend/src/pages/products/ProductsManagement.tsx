                        ...
                        {loading ? (
                            ...
                            <div className="space-y-8">
                                ...
                                {filteredApps.length === 0 && filteredProducts.length === 0 && (
                                    <div className="text-center py-12">
                                        <div className="w-12 h-12 bg-gray-200 dark:bg-white/10 rounded-xl flex items-center justify-center mx-auto mb-4">
                                            <ShoppingBag className="w-6 h-6 text-gray-400" />
                                        </div>
                                        <h3 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-1">{t('product_pages.management_title')}</h3>
                                        <p className="text-xs text-gray-600 mb-4">{t('create_product.title')}</p>
                                        <button
                                            onClick={handleCreateProduct}
                                            className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-4 py-2 rounded-lg font-medium transition-colors inline-block text-xs"
                                        >
                                            {t('create_product.title')}
                                        </button>
                                    </div>
