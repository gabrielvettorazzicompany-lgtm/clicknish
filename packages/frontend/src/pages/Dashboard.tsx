...
function Dashboard() {
  ...
  // Conectar aos dados de vendas com localização da tabela sale_locations (filtrado por moeda e data)
  const { countries, loading: loadingGeolocation } = useSalesGeolocation(user?.id, selectedCurrency, dateRange)
