...
import { ArrowLeft, Plus, Eye, Trash2, Check, Clock, Upload, GripVertical } from 'lucide-react'
                        ...
                        <div className="max-w-[1920px] mx-auto">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h1 className="text-sm font-semibold text-gray-900 dark:text-white leading-tight">{funnel.name}</h1>
