  ...
  return (
    <div className={containerClass}>
      ...
      <button
        ...
        className={`w-full disabled:opacity-40 disabled:cursor-not-allowed text-white font-medium rounded-lg transition-all duration-200 text-[13px] flex items-center justify-center gap-2 active:scale-[0.98] ${isMobile ? 'py-3 mb-4' : 'py-2.5'
          }`}
