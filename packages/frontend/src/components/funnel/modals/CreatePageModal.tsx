                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2.5 bg-white dark:bg-transparent border border-gray-300 dark:border-[#27272a] rounded-lg text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-400 focus:outline-none focus:border-blue-500 dark:focus:border-[#52525b]"
                            disabled={creating}
                            required
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="w-full px-4 py-2.5 bg-white dark:bg-transparent border border-gray-300 dark:border-[#27272a] rounded-lg text-gray-900 dark:text-white focus:outline-none focus:border-blue-500 dark:focus:border-[#52525b] appearance-none"
                                disabled={creating}
                                required
                            >
                    ...
                    <div className="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-[#27272a]">
                        <button
                            ...
                            onClick={onClose}
                            disabled={creating}
                            className="px-6 py-2.5 text-zinc-400 hover:text-white rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                        >
                            {t('common.cancel')}
                        </button>
                        <button
                            ...
                            className="px-6 py-2.5 bg-white hover:bg-zinc-100 text-black rounded-lg font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                        >
