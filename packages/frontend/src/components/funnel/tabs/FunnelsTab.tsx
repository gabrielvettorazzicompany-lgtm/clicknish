            ...
            <div className="bg-white dark:bg-white/[0.02] rounded-xl border border-gray-200 dark:border-white/[0.06] overflow-hidden">
                {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-16 gap-3">
                        ...
                        <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{t('funnels.empty')}</p>
                        <p className="text-xs text-gray-500 dark:text-gray-400">{t('funnels.empty_hint')}</p>
                        <button
                            onClick={onCreateClick}
                            className="mt-1 flex items-center gap-1.5 px-4 py-2 text-xs font-medium bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-all"
                        >
                            <Plus size={13} /> {t('funnels.new_funnel')}
                        </button>
                    </div>
                ) : (
