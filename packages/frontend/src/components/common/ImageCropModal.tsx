...
export default function ImageCropModal({
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-60">
            <div className="bg-[#1a1d2e] rounded-lg shadow-2xl max-w-xs w-full mx-4">
                {/* Header */}
                ...
                <div className="p-3">
                    ...
                    {/* Controle de Zoom */}
                    <div className="mb-2">
                        <label className="block text-xs font-medium text-gray-300 mb-1">{t('common.zoom')}</label>
                        <input
                            type="range"
                            min="0.1"
                            max="3"
                    ...
                    <div className="flex gap-3">
                        <button
                            type="button"
                            onClick={handleClose}
                            className="flex-1 px-4 py-2 text-sm text-gray-300 bg-[#252941] hover:bg-[#252941] rounded-lg font-medium transition-colors"
                        >
                            {t('common.cancel')}
                        </button>
                        <button
