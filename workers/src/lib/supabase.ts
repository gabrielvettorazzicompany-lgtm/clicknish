...
class SupabaseQuery {
    ...
    not(column: string, operator: string, value: any) {
        this.queryParams.push(`${column}=not.${operator}.${value}`)
        return this
    }
    ...
    like(column: string, value: string) {
        this.queryParams.push(`${column}=like.${value}`)
        return this
    }

    ilike(column: string, value: string) {
        this.queryParams.push(`${column}=ilike.${value}`)
        return this
    }

    or(filters: string) {
        this.queryParams.push(`or=(${filters})`)
        return this
    }
